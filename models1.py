...
class SideNet(nn.Module):
    def __init__(self, bb_model, train_bb=False, limb_size=32, num_classes=101, verbose=False, 
        ...
        self.resnet_blocks_output_shape = {"l1": 256, "l2": 512, "l3": 1024, "l4": 2048}
        mul = 2
        ...
        my_blocks_input_shape = {"l1": self.resnet_blocks_output_shape['l1'], 
                                 "l2": self.resnet_blocks_output_shape["l2"] + my_blocks_output_shape["l1"], 
                                 "l3": self.resnet_blocks_output_shape["l3"] + my_blocks_output_shape["l2"], 
                                 "l4": self.resnet_blocks_output_shape["l4"] + my_blocks_output_shape["l3"]}
        self.my_blocks_output_shape = my_blocks_output_shape
        self.my_blocks_input_shape = my_blocks_input_shape
    ...
    def forward(self, x):
        l1,l2,l3,l4,x_bb = self.call_bb(x)
        x = self.l1_layers(l1)
    ...
    def call_bb(self, x):
        ...
        return l1,l2,l3,l4,x_bb
    
class SideNetGroups(SideNet):
    def __init__(self, bb_model, train_bb=False, limb_size=32, num_classes=101, verbose=False,
                 constant_block_size=False):
        super().__init__(bb_model, train_bb=False, limb_size=32, num_classes=101, verbose=False,
                 constant_block_size=False)       
